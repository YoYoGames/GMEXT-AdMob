...
void admob_events_on_paid_event(bool enabled, const gm::wire::GMFunction& callback);
...
void admob_server_side_verification_set(std::string_view user_id, std::string_view custom_data);
